...
export function WalletSelector(walletSortingOptions: WalletSortingOptions) {
  ...
  const copyPublicKey = useCallback(async () => {
    ...
    try {
      await navigator.clipboard.writeText(account.publicKey as string);
      toast({
        title: "Success",
        description: "Copied wallet public key to clipboard.",
      });
    } catch {
      toast({
        variant: "destructive",
        title: "Error",
        description: "Failed to copy wallet public key.",
      });
    }
  }, [account?.publicKey, toast]);
  ...
  return connected ? (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        {/* <DropdownMenuItem onSelect={copyPublicKey} className="gap-2">
